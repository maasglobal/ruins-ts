...
describe('crash library', () => {
  ...
  describe('crashMessage', () => {
    it('should return input as JSON if possible', () => {
      expect(exampleCrashMessage).toEqual(
        JSON.stringify(exampleJSON)
      );
    });
    it('should fallback to String() when JSON is not an option', () => {
      expect(crashMessage(exampleCyclic)).toEqual(
        String(exampleCyclic),
      );
    });
  });
  ...
  describe('crashObject', () => {
    it('should return an error object', () => {
      expect(exampleCrashObject).toEqual(
        new Error(crashMessage(exampleJSON))
      );
    });
  });
  ...
  describe('crash', () => {
    it('should crash', () => {
      expect(exampleCrash).toThrowError(
        exampleCrashObject,
      );
    });
  });
